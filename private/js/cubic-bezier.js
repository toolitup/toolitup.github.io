...
var clippy = function() {
	...
	var output = _.chain(prefixes).map(function(p) { return p + content + ";\n"; }).reduce(function(i,e) { return i + e;},"").value().trim();
...
/* resource : http://13thparallel.com/archive/bezier-curves/ */
var cubicBezier =  {};
cubicBezier.B1 = function(t) { return t * t * t };
cubicBezier.B2 = function(t) { return 3 * t * t * (1 - t) };
cubicBezier.B3 = function(t) { return 3 * t * (1 - t) * (1 - t) };
cubicBezier.B4 = function(t) { return (1 - t) * (1 - t) * (1 - t) };
